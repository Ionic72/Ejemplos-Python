...
#ejemplo de bucles (en un futuro hablaremos a detalle de los bucles) para el manejo de operadores aritmetico u operadores asignados
x = 0
for x in range(10):
    x += 1 #es lo mismo que x = x + 1
    print(x)

#Ejemplos con condicionales (en un futuro hablaremos a detalle de esto) para dar a entender el uso de operadores relacionales y lógicos
